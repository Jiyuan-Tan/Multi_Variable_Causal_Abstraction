...
# ---------------------------------------------------------------------------
# causalab on PYTHONPATH (prefer: pip install -e ./causalab from repo root)
# ---------------------------------------------------------------------------
_REPO_ROOT = Path(__file__).resolve().parents[3]
_causalab_repo = _REPO_ROOT / "causalab"
if _causalab_repo.is_dir() and str(_causalab_repo) not in sys.path:
    sys.path.insert(0, str(_causalab_repo))
