...
from neural.token_position_builder import (
    TokenPosition,
...
from tasks.entity_binding.token_positions import get_entity_token_positions
...
def create_token_positions(pipeline: LMPipeline, task_config):
    ...
    original_combined = combined_token_position(
        [g0_e0_last, g0_e1_last, g1_e0_last, g1_e1_last],
        id="g0_g1"
    )
    ...
    counterfactual_combined = combined_token_position(
        [g1_e0_last, g1_e1_last, g0_e0_last, g0_e1_last],
        id="g1_g0"
    )
