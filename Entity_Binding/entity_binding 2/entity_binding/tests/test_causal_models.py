...
def test_positional_search_mechanism():
    ...
    moved_output = model.run_forward(moved_sample)
...
def test_models_with_counterfactual_swap():
    ...
    direct_cf = direct_model.run_forward(counterfactual)
    positional_cf = positional_model.run_forward(counterfactual)
...
def demonstrate_model_comparison():
    ...
    direct_out = direct_model.run_forward(input_sample)
    pos_out = positional_model.run_forward(input_sample)
    ...
    direct_swap = direct_model.run_forward(swapped)
    pos_swap = positional_model.run_forward(swapped)
